...
#B0 invariant mass
nbin, nmin, nmax = 100, 3, 18

B0_mass_sign_h = df0.Histo1D(("B0 mass histo", "B0 mass signal distr", nbin, nmin, nmax),"invMassB0")
...
#TT invariant mass
nbin, nmin, nmax = 100, 3, 9

TT_mass_sign_h = df0.Histo1D(("TT mass histo", "TT mass signal distr", nbin, nmin, nmax),"invMassTT")
...
B0_pt_comb_h = df2.Histo1D(("B0 pt histo", "B0 pt comb distr", nbin, nmin, nmax),"pt_B0")
...
c = ROOT.TCanvas()
B0_pt_sign_h.Draw("HIST")
B0_pt_comb_h.Draw("HIST SAME")
...
pointingCos_sign_h = df0.Histo1D(("pointing Cos", "pointingCos sign distr", nbin, nmin, nmax), "pointingCos")
...
B0_eta_spec_h = df1.Histo1D(("B0 eta histo", "B0 eta spec distr", nbin, nmin, nmax),"eta_B0")
...
flightLength3D_comb_h = df2.Histo1D(("flightLength3D", "flightLength3D comb distr", nbin, nmin, nmax), "flightLength3D")
...
dR_TPlusTMinus_sign_h = df0.Histo1D(("dR_TPlusTMinus", "dR_TPlusTMinus sign distr", nbin, nmin, nmax), "dR_TPlusTMinus")
...
vertexChi2_sign_h = df0.Histo1D(("vertexChi2", "vertexChi2 sign distr", nbin, nmin, nmax), "vertexChi2")
