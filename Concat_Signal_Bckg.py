...
files = [
    "Signal_features_triggered.root",
    "Spec_Bckg_features_triggered.root",
    "Comb_Bckg_features_triffered.root",
]
...
df.Snapshot("myTree", "merged_triggered.root")

print("Wrote merged_triggered.root")
