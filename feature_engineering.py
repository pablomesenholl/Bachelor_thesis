...
file = ROOT.TFile.Open("Simulation_Data.root")
file.ls()
...
df.Snapshot("tree", "Signal_features.root")
...
mass_TT_h = df.Histo1D(("mass_TT_histo", "TT Mass distribution", 100, 3, 5), "invMassTT")
...
pt_B0_h = df.Histo1D(("pt_B0_histo", "B0 pt distribution", 100, 0, 10), "pt_B0")
...
mass_B0_h.Draw()
c.Update()
c.SaveAs("Plots_Signal_Simulation/B0 mass distribution.png")

c = ROOT.TCanvas()
mass_TT_h.Draw()
c.Update()
c.SaveAs("Plots_Signal_Simulation/TT mass distribution.png")

c = ROOT.TCanvas()
VertexChi2_h.Draw()
c.Update()
c.SaveAs("Plots_Signal_Simulation/VertexChi2 distribution.png")

c = ROOT.TCanvas()
eta_B0_h.Draw()
c.Update()
c.SaveAs("Plots_Signal_Simulation/B0 eta distribution.png")

c = ROOT.TCanvas()
eta_TPLus_h.Draw()
c.Update()
c.SaveAs("Plots_Signal_Simulation/TPlus eta distribution.png")

c = ROOT.TCanvas()
phi_B0_h.Draw()
c.Update()
c.SaveAs("Plots_Signal_Simulation/B0 phi distribution.png")

c = ROOT.TCanvas()
pt_B0_h.Draw()
c.Update()
c.SaveAs("Plots_Signal_Simulation/B0 pT distribution.png")

c = ROOT.TCanvas()
pointingCos_h.Draw()
c.Update()
c.SaveAs("Plots_Signal_Simulation/pointingCos distribution.png")

c = ROOT.TCanvas()
flightLength_h.Draw()
c.Update()
c.SaveAs("Plots_Signal_Simulation/flightLength distribution.png")